CREATE TABLE [meta].[SourcePartition] (
    ...
    CONSTRAINT [FK_SourcePartition_SourceConnection] FOREIGN KEY ([SourceConnectionID]) REFERENCES [meta].[SourceConnection] ([SourceConnectionID])
);
